...
describe('GetCharactersByOwnerUseCase (Integration)', () => {
    ...
    it('deve retornar a lista de personagens de um usuário específico', async () => {
        const char1 = new DnD5eCharacter('char-1', 'Aragorn', 'user1', new Attributes(), new HealthPoints(10, 10), 1);
        const char2 = new DnD5eCharacter('char-2', 'Legolas', 'user1', new Attributes(), new HealthPoints(10, 10), 1);
        const char3 = new DnD5eCharacter('char-3', 'Gimli', 'user2', new Attributes(), new HealthPoints(10, 10), 1);
